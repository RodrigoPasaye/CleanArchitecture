...
namespace CleanArchitecture.Infrastructure.Configurations {
  internal sealed class AlquilerConfiguration : IEntityTypeConfiguration<Alquiler> {
    public void Configure(EntityTypeBuilder<Alquiler> builder) {
      ...
      builder.OwnsOne(alquiler => alquiler.Precio, precioBuilder => {
        precioBuilder.Property(moneda => moneda.TipoMoneda).HasConversion(tipomoneda => tipomoneda.Codigo, codigo => TipoMoneda.FromCodigo(codigo!));
      });
